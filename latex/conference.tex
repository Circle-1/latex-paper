...
\hline
\multicolumn{2}{c}{CNN-LSTM (proposed)} & \multicolumn{2}{c}{MSE = 0.03 (Avg)} \\
...
\multicolumn{2}{c}{IKN-ConvLSTM \cite{b14}} & \multicolumn{2}{c}{98.307\%} \\
\multicolumn{2}{c}{k-NN Regression \cite{b15}} & \multicolumn{2}{c}{90\%} \\
\multicolumn{2}{c}{Rider-MBO-based Deep-ConvLSTM \cite{b16}} & \multicolumn{2}{c}{MSE = 7.2487, RMSE = 2.6923} \\
\multicolumn{2}{c}{SVM \& Logistic Regression \cite{b17}} & \multicolumn{2}{c}{87\% to 90\%} \\
\multicolumn{2}{c}{SVM with RBF Kernel \cite{b18}} & \multicolumn{2}{c}{89\%} \\
\multicolumn{2}{c}{LSTM \cite{b19}} & 
\multicolumn{2}{c}{MSE = 3.5 to 3.7} \\
\hline
\end{tabular}
\end{table}
